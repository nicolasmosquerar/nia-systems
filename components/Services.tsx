const services = [
  {
    ...
    description: "Revisamos tu estado actual en AWS, GCP, Azure u on-prem. Entregamos hallazgos priorizados, plan de remediación y roadmap de 12 meses.",
  ...
  },
  {
    ...
    description: "Clústers listos para producción: GitOps, observabilidad, políticas de seguridad y multi-tenancy. En cualquier cloud.",
  ...
  },
  {
    ...
    description: "Asistentes y automatizaciones que hablan con tus datos internos. Desplegados en tu infraestructura o en la nube.",
  ...
  },
  {
    ...
    description: "Talleres prácticos por rol: SRE, platform engineers, AI engineers. Capacitamos a tu equipo en tu stack real.",
