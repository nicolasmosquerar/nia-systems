const services = [
  ...
  },
  {
    ...
    description: "Tu equipo de producto deja de esperar a infra para desplegar. Construimos la plataforma interna que unifica pipelines, observabilidad y seguridad — en AWS, GCP, Azure o donde ya estés. En 6 semanas tu equipo hace push a producción sin abrir un ticket.",
  ...
  },
  {
    ...
    description: "Tu equipo opera lo que construimos sin esperar a que volvamos. La transferencia de conocimiento es parte del proyecto, no un extra. Talleres por rol — SRE, platform engineers, ingenieros de producto — sobre tu stack real. Cuando terminamos, tu equipo toma decisiones de infra sin depender de consultores.",
    price: "Desde $1,500 USD",
    tag: "Multiplica el ROI del proyecto",
  },
  {
    ...
    description: "Tus datos internos dejan de ser un activo subutilizado. Cuando la infraestructura ya está en orden, el siguiente paso es automatizar lo que consume tiempo de tu equipo. Asistentes y agentes que llegan a producción en 3–6 semanas — sin depender de que algún proveedor cambie su API.",
    price: "Desde $5,000 USD",
    tag: "Para cuando ya tenés infra",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="mb-10">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-teal-50 border border-teal-100 rounded-full">
            ...
            <span className="text-sm text-teal-700 font-medium">
              El diagnóstico define qué servicio necesitás — y en qué orden.
            </span>
          </div>
        </div>
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-14">
          ...
          <p className="text-neutral-500 max-w-xs text-base leading-relaxed lg:text-right">
            Cada servicio tiene un entregable definido, un plazo claro y métricas para saber si funcionó.
          </p>
        </div>
