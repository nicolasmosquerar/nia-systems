const services = [
  {
    ...
    description: "Identificamos dónde aplicar IA primero. Entregamos un plan priorizado con quick wins, ROI estimado y recomendación de primer piloto.",
    price: "Desde $800 USD",
  ...
  },
  {
    ...
    description: "Automatizamos documentos, correos, reportes, onboarding y más. Flujos conectados a las herramientas que ya usas.",
  ...
  },
  {
    ...
    description: "Tu empresa habla con su propia información. Asistentes que consultan documentos internos, responden preguntas y ejecutan tareas.",
  ...
  },
  {
    ...
    description: "Talleres prácticos por rol: directivos, operaciones, desarrolladores. No solo prompts — nuevas formas de trabajo con IA.",
    price: "Desde $500 USD",
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6 mb-14">
          ...
          <p className="text-neutral-500 max-w-xs text-base leading-relaxed lg:text-right">
            Empezamos simple y escalamos según lo que tu negocio necesite.
          </p>
        </div>
        ...
        <p className="mt-10 text-center text-sm text-neutral-400 max-w-lg mx-auto">
          También ofrecemos servicios avanzados: integraciones con sistemas internos,
          modelos locales (IA soberana), sistemas multi-agente y IA para desarrolladores.
        </p>
      </div>
    </section>
  );
