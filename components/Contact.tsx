...
const perks = [
  {
    ...
    description: "30 minutos para entender tu situación y ver si podemos ayudarte.",
  },
  {
    icon: "M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z",
    title: "Resultados rápidos",
    description: "Pilotos en 3-6 semanas con métricas claras desde el día uno.",
  },
  {
    icon: "M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z",
    title: "Sin compromiso",
    description: "Empezamos con un diagnóstico acotado. Tú decides si seguimos.",
  },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20">
          ...
          <div>
            ...
            <p className="mt-5 text-lg text-neutral-500 leading-relaxed">
              Cuéntanos qué desafío enfrenta tu empresa. Te respondemos en menos
              de 24 horas con una propuesta de cómo podemos ayudarte.
            </p>
